...
export const COLLECTION_CONFIGS: Record<string, CollectionConfig> = {
  ...
  rings: {
    ...
    ogDescription: `${APP_NAME}'s premium ring collection — gold, diamond, and precious stone rings crafted for every occasion.`,
  ...
  necklaces: {
    ...
    ogDescription: `${APP_NAME}'s necklace collection — from delicate gold chains to statement diamond pieces.`,
  ...
  earrings: {
    ...
    ogDescription: `${APP_NAME}'s earring collection — gold jhumkas, diamond studs, hoops and more for every occasion.`,
  ...
  bracelets: {
    ...
    ogDescription: `${APP_NAME}'s bracelet collection — gold bangles, diamond tennis bracelets and charm bracelets.`,
    heroTagline: "Wrap It Up",
    heroParagraph: "From delicate gold chains to bold diamond bracelets — wear elegance on your wrist.",
    emoji: "⭐",
  ...
  pendants: {
    ...
    ogDescription: `${APP_NAME}'s pendant collection — gold and diamond pendants crafted with exceptional detail.`,
  ...
  bangles: {
    ...
    heading: "Bangles",
    description: `Shop beautiful bangles at ${APP_NAME}. Traditional gold bangles, Kundan bangles & modern designs. BIS Hallmarked. Free shipping above ₹999.`,
    ogDescription: `${APP_NAME}'s bangle collection — from traditional gold bangles to modern contemporary designs.`,
  ...
  anklets: {
    ...
    heading: "Anklets",
    description: `Shop delicate anklets at ${APP_NAME}. Silver anklets, gold anklets & diamond anklets. Handcrafted elegance for your feet. Free shipping above ₹999.`,
    ogDescription: `${APP_NAME}'s anklet collection — delicate silver and gold anklets for everyday elegance.`,
    heroTagline: "Grace in Every Step",
    heroParagraph: "Delicate anklets that add a touch of grace — from minimalist silver to ornate gold.",
    emoji: "🦶",
  ...
  mangalsutra: {
    ...
    heading: "Mangalsutra",
    description: `Discover beautiful mangalsutra at ${APP_NAME}. Traditional gold mangalsutra, diamond mangalsutra & modern designs. BIS Hallmarked. Free shipping above ₹999.`,
